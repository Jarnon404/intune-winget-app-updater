# ============================================================
# Intune Winget App Update Remediation v10.4 - Hybrid Registry
# Remediation script
#
# Purpose:
...
# - Adds explanation for winget list code -1978335162
...
Write-Log "============================================================"
Write-Log "Starting winget update remediation v10.4 hybrid registry"
...
Write-Log "All app update failures are treated as warnings in v10.4."
Write-Log "Log retention days: $LogRetentionDays"
Write-Log "Max log folder size MB: $MaxLogFolderSizeMB"
Write-Log "Script version: Remediation v10.4"
...
if (-not $WingetPath) {
    ...
    Write-FinalOutput -Line "WINGET_REMEDIATION_V10_4 | Computer=$env:COMPUTERNAME | Status=WingetMissing | SourceUpdateStatus=NotRun | AttemptedApps=None | UpdatedApps=None | WarningApps=WingetMissing | SkippedApps=None | RegistryOnlyApps=None | UnknownApps=None | RebootPending=$RebootPending | Exit=0" -ExitCode 0
}
...
if ($SourceUpdateStatus -like "TechnicalFailure*") {
    ...
    Write-FinalOutput -Line $FinalSource -ExitCode 0
}
